...
public class CrrManagerService {
    ...
    public long revokeCertificate(long cert_key_toRevoke, long raop_cert_key, 
        ...
        // throw early  
        if(cert_key_toRevoke <=0 ){throw new IllegalArgumentException("Invalid cert_key_toRevoke"); }
        if(raop_cert_key <= 0){ throw new IllegalArgumentException("Invalid raop_cert_key"); }
        if(reason == null ){throw new IllegalArgumentException("Invalid reason"); }
    ...
    public void deleteRevocationRequest(long crr_key_toDelete, long raopId){
       // throw early  
       if(crr_key_toDelete <=0 ){throw new IllegalArgumentException("Invalid crr_key_toDelete"); } 
