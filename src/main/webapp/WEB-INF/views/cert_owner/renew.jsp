                ...
                <div class="col-xs-offset-1">
                   ...
                   <c:if test="${createCsrOnClientOrServer == 'client'}">
                        <ul>
                            ...
                            <li><strong>ONLY the public key</strong> is sent to the server as a  <abbr title="Certificate Signing Request">CSR</abbr>. 
                                The private key and password are <strong>NOT</strong> sent to the server.</li>   
                            <li>After clicking Submit, you will be asked to <strong>save your private key</strong> - you must do this. Also remember your key <b>password</b>.</li>
                            <li>You will then be e-mailed when your certificate is ready to download.</li>
                            <li>If the browser crashes or a timeout occurs and you are not asked to save the private key, please contact your RA or the CA.</li>
                        </ul>
                    </c:if>
...
<!--                    <div id="IE11warning" class="col-xs-11 col-lg-10 alert alert-danger" role="alert" style="display: none;">
                    ...
                    <c:if test="${certificateRow.status == 'VALID'}">
                        <a id="postLinkViaClient" href="${pageContext.request.contextPath}/cert_owner/renewViaClient" style="display: none;"></a>
                        <a id="postLinkViaServer" href="${pageContext.request.contextPath}/cert_owner/renewViaServer" style="display: none;"></a>
                        
                        <form action="" class="form-horizontal" role="form"> 
                            <div class="form-group">
                                <div class="col-xs-3 col-lg-3">
                                    <strong><a href="#" id="emailTitle" tabindex="-1" data-toggle="tooltip" data-placement="right" 
                                    title="Email that is associated with your Certificate">e-Mail</a></strong>
                                </div>
                                <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
                                    <input type="text" id="emailInputText" value="${certificateRow.email}" class="form-control"/><span></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-3 col-lg-3">
