        ...
        <div id="wrap">
            <div class="row">
                <div class="col-xs-offset-1 col-xs-11">
                    ...
                    <a id="chrome"><strong>Chrome</strong></a> If you are sure you have loaded your certificate into your browser, you may 
                    ...
                    <br/> <br/> 
                    <img src="${pageContext.request.contextPath}/resources/images/chrome1.jpg" class="img-responsive" alt="chome settings" style="width: 650px;"/>
                    <br/> <br/> 
                    ...
                    <br/> <br/> 
                    <img src="${pageContext.request.contextPath}/resources/images/ffclear1.png" class="img-responsive" alt="ff settings 1"/>
                    <br/> <br/> 
                    <img src="${pageContext.request.contextPath}/resources/images/ffclear2.png" class="img-responsive" alt="ff settings 2"/>
                    <br/> <br/> 
                    ...
                    <br/> <br/> 
                    <img src="${pageContext.request.contextPath}/resources/images/ffprompt.png" class="img-responsive" alt="ff prompt"/>

                    <br/>
                    <br/>

                    <p><a id="safari"><strong>Safari</strong></a>  
                        If you have a client certificate in your Safari keychain, including certificates <strong>not</strong> issued from 
                        the UK CA, then Safari always (wrongly) insists the user selects a certificate (cancelling leads to denied page).
                        This is because Safari wrongly treats clientAuth="want" (i.e. optional) as clientAuth="Required":
                        See <a href="http://superuser.com/questions/521919/safari-forces-user-to-select-client-certificate-even-if-it-is-optional">Bug</a>
                    ...
                    <p>Additionally, Safari 'remembers' SSL certificate choice and will not 
                        prompt again after selection. See <a href="https://discussions.apple.com/message/19828596#19828596">Here</a>.</p>
                    <p>--Workaround--: <br/>Use another browser, remove certificates from keychain, or select suitable UK CA client certificate.<br/>
                        Can manually assign a certificate from the keychain as <a href="http://support.apple.com/kb/HT1679">Here</a>.
                    </p>
                    <br/><br/>
                </div>
            </div>
