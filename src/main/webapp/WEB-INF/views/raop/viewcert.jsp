                        ...
                        <table class="table table-hover table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <c:url value="/raop/searchcsr/search?name=${cert.cn}&ra=all&status=all&searchNullEmailAddress=false" var="backsearchcsroncn"/>
                                    <td><a href="${backsearchcsroncn}">${cert.cn}</a> &larr; <font class="muted">search for matching CSRs for CN</font></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><a href="mailto:${cert.email}" id="currEmail">${cert.email}</a>
                                        <form:form method="post" action="${pageContext.request.contextPath}/raop/viewcert/rachangemail"> 
                                        <div id="inputEmail">
                            ...
                            <c:if test="${viewerCanFullRevoke}">
                                <div class="form-group">
                                    <form:form method="post" action="${pageContext.request.contextPath}/raop/viewcert/fullrevoke"
                                        ...
                                        <input name="cert_key" type="hidden" value="${cert.cert_key}" />
                                        <div class="col-xs-7">
                                            <form:input path="reason" class="form-control" placeholder="Reason to revoke (value is required)" />
                                        </div>
