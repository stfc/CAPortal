...
<html>
                    ...
                    <form:form id="form" method="post" action="${pageContext.request.contextPath}/raop/searchcert"
                        ...
                        <sec:authorize access="hasRole('ROLE_CAOP')">
                            <div class="form-group">
                                ...
                                <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
                                    <form:checkbox path="searchNullEmailAddress"/>&nbsp;&nbsp;<font class="muted">(if checked, this will override email search string above)</font>
                                </div>
                            </div>
                        </sec:authorize>
                        <div class="form-group">
                            <div class="col-xs-3 col-lg-3">
                                <strong>Serial Number</strong> <font class="muted" style="text-decoration: underline">(if given, other search criteria are ignored)</font>&nbsp;&nbsp;
                            </div>
                            <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
    ...
    <!--                                    <td>
                                        ...
                                        <%--${cert.notAfter}--%>
                                        <td class="vertAlign">
                                            <button type="button" class="btn btn-sm dnPop" data-container="body" data-toggle="popover" 
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    to [<b>${sessionScope.certSearchPageHolder.row + fn:length(sessionScope.certSearchPageHolder.source)}</b>]
