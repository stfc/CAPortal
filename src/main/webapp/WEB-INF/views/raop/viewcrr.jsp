                ...
                <div class="col-xs-offset-1">    
                    ...
                    <div class="col-xs-11 col-lg-10">
                        <table class="table table-hover table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="${pageContext.request.contextPath}/raop/viewcert?certId=${crr.cert_key}">${crr.cert_key}</a></td>
                                </tr>
                                <%--<tr>
                                    <td>Data</td>
                        ...
                        <c:if test="${canDeleteCrr}">
                            <h3>Actions:</h3>
                            <form:form method="post" action="${pageContext.request.contextPath}/raop/viewcrr/delete" commandName="crr">
                        ...
                        <c:if test="${canApproveCrr}">
                            <form:form method="post" action="${pageContext.request.contextPath}/raop/viewcrr/approve" commandName="crr">
                                <form:hidden path="crr_key" /> 
