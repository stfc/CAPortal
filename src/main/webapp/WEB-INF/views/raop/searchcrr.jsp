                ...
                <div class="col-xs-offset-1">
                    ...
                    <form:form id="form" method="post" action="${pageContext.request.contextPath}/raop/searchcrr"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
                                <form:input path="dn" placeholder="CN=some body,L=DL,OU=CLRC,O=eScience,C=UK" class="form-control"/> 
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    to [<b>${sessionScope.crrSearchPageHolder.row + fn:length(sessionScope.crrSearchPageHolder.source)}</b>]
