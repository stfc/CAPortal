                    ...
                    <div class="col-xs-11 col-lg-10">
                        ...
                        <table class="table table-hover table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>CN</td>
                                    <c:url value="/raop/searchcert/search?name=${csr.cn}&ra=all&status=VALID&notExpired=true&roll=all&searchNullEmailAddress=false" var="backsearchcert"/>
                                    <td><a href="${backsearchcert}">${csr.cn}</a> &larr; <font class="muted">search for matching certificates</font></td>
                                </tr>        
                                <tr>
                                    <td>DN</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="JavaScript:newPopup('${pageContext.request.contextPath}/raop/verifyPin?pin=${pin}');">Verify Pin (opens in new window)</a>
                                    </td>
                                </tr>        
                            </tbody>
                        </table>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${not empty csr.bulk}">
                                                <span class="glyphicon glyphicon-ok" style="color:green; font-size: large;"></span> &nbsp; <br/>
                                                <button type="button" class="btn btn-xs btn-primary" 
                                                        onclick="window.location='${pageContext.request.contextPath}/raop/viewbulk?bulkId=${csr.bulk}';">
                                                    Manage Bulk 
                                                </button> (Approve/Delete selected CSRs in Bulk)
                                                <br/><br/> 
                            ...
                            <tbody>
                                <tr>
                                    <c:if test="${csr.status == 'NEW' || csr.status =='RENEW'}">
                                        <td>
                                            <form:form method="post" action="${pageContext.request.contextPath}/raop/viewcsr/approve"
                                                commandName="csr"> 
                                                <form:hidden path="status"/>
                                                <form:hidden path="req_key"/>
                                                <button type="submit" class="btn btn-sm btn-primary" 
                                                        onclick="return confirm('Are you sure you want to Approve this request?');">Approve Request
                                                </button>&nbsp;&nbsp;
                                            </form:form> 
                                        </td>
                                    </c:if>
                                        ...
                                        <td>
                                            <form:form method="post" action="${pageContext.request.contextPath}/raop/viewcsr/delete"
                                                ...
                                                <button type="submit" class="btn btn-sm btn-danger" 
                                                        onclick="return confirm('Are you sure you want to Delete this request?');">Delete Request</button>
                                            </form:form> 
                                        </td>
                                    </c:if>
                                </tr>
