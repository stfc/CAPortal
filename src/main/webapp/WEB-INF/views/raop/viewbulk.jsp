                            ...
                            <tbody>
                                ...
                                <%-- You must bind here the properties you want posting with form:x --%>
                                    <tr>
                                        ...
                                        <td> <a href="${pageContext.request.contextPath}/raop/viewcsr?requestId=${rowWrapper.requestRow.req_key}">
                                        ...
                                        <c:choose>
                                            <c:when test="${rowWrapper.requestRow.status == 'NEW' || 
                                                ...
                                                <td style="text-align:center"><form:checkbox path="rows[${status.index}].checked"/></td>
<!--                                                <td><input type="submit" class="btn btn-sm btn-primary" value="Approve" 
                                            ...
                                            <c:otherwise>
                                                <td>No action allowed</td><!--<td>No action</td><td>No action</td>-->
                                            </c:otherwise>
                                        </c:choose>
                                    </tr>
                                </c:forEach>
                        ...
                        <button type="button" class="btn btn-warning" onclick="javascript:history.go(-1)">Cancel</button>
                    </form:form>
                        <br/>
                        <br/>
                        <br/>
