                ...
                <div class="col-xs-offset-1">
                    ...
                    <div class="col-md-offset-1 col-md-4">
                        <div class="col-md-offset-1">
                            <img src="${pageContext.request.contextPath}/resources/images/user1.png" class="img-responsive centeredImg" alt="user icon" width="160"/>
                            ...
                            <div class="form-group"> 
                                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/pub/requestUserCert/submitNewUserCertRequest"
                                   data-toggle="tooltip" data-placement="bottom" title="Apply for a new user certificate">Request New User Certificate</a> 
                                <a class="btn btn-info wrapped-btn" href="http://ngs.ac.uk/UKCA" data-toggle="tooltip" data-placement="bottom" 
                                ...
                                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/pub/viewralist"
                                   data-toggle="tooltip" data-placement="bottom" title="Find your nearest Registration Authority">Find My Local RA</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="col-md-offset-2">
                            <img src="${pageContext.request.contextPath}/resources/images/user1cert.png" class="img-responsive centeredImg" alt="user + cert" width="160"/>
                            <h2 class="spacedH2" data-toggle="tooltip" data-placement="top" title="You either already have a valid 
                                certificate installed into your browser, or have applied for one">I have a grid certificate
                            </h2> 
                            <div class="form-group">
                                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/pub/downloadCert/requestdownload"
                                ...
                                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/cert_owner/requestHostCert"
                                   data-toggle="tooltip" data-placement="bottom" title="Apply for a new certificate for a host - you
                                   MUST currently have a user certificate installed and selected for this">Request New Host Certificate
                                </a> 
