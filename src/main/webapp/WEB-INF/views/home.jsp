...
<div id="wrap" class="container">
    ...
    <div class="row align-items-center">
        ...
        <div class="col align-content-center text-center">
            <img src="${pageContext.request.contextPath}/resources/images/user1cert.png" class="img-responsive centeredImg" alt="user + cert" width="160"/><br />
            ...
            <div class="form-group">
                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/pub/downloadCert/requestdownload" data-toggle="tooltip" data-placement="bottom" title="Download your user/host certificate once it has been approved and you have been e-mailed your certificate serial number">Download a Certificate</a>
                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/cert_owner" data-toggle="tooltip" data-placement="bottom" title="Select a certificate from those installed in your current browser, or view currently selected certificate">Login / View My Certificate</a>
                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/cert_owner/requestHostCert" data-toggle="tooltip" data-placement="bottom" title="Apply for a new certificate for a host - you MUST currently have a user certificate installed and selected for this">Request New Host Certificate</a>
                <a class="btn btn-info wrapped-btn" href="${pageContext.request.contextPath}/cert_owner/renew" data-toggle="tooltip" data-placement="bottom" title="Renew a certificate when you have received an email instructing you to do so">Renew Certificate</a>
            </div>
        </div>
    </div>
</div>
