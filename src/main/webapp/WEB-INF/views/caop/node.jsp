                    ...
                    <div class="col-xs-12">
                        <form method="post">
                            ...
                            <c:if test="${disableExport == false}">
                                <input type="submit" value="Export" class="btn btn-primary" formaction="${pageContext.request.contextPath}/caop/node/export"/>
                            </c:if>
                            ...
                            <c:if test="${disableImport == false}">
                                <input type="submit" value="Import" class="btn btn-primary" formaction="${pageContext.request.contextPath}/caop/node/import"/>
                            </c:if>
                        </form>
                    </div>
                </div>
