        ...
        <div id="wrap">
            <div class="row">
                <div class="col-xs-offset-1">
                    ...
                    <div class="col-xs-11">
                        <br/>
                    [<b>${fn:length(approved_reqrows)}</b>] Approved <b>CSRs</b> [<b>${fn:length(crr_reqrows)}</b>] Approved <b>CRRs</b>
                    ...
                    <br/><br/>
                        ...
                        <button id="exportBt" type="submit" class="btn btn-md btn-primary"
                            ...
                            onclick="return confirm('Are you sure you want to export approved requests for signing?');">Export - NOT IMPLEMENTED YET
                        </button>
                    </div>
                </div>
            </div>
