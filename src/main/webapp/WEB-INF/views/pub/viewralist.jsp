        ...
        <div id="wrap">
            <div class="row">
                <div class="col-xs-offset-1">
                    ...
                    <h5>If you are having problems finding an RA, please contact us on the helpdesk and we'll be happy to help</h5>
                    <br/>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="rarow" items="${editRalistFormBean.source}" varStatus="loopVar">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="${pageContext.request.contextPath}/pub/viewRAs?ou=${rarow.ou}">${rarow.ou}</a></td>
                                            <td>${rarow.l}</td>
                                            <%--<td>${rarow.active}</td>--%>
