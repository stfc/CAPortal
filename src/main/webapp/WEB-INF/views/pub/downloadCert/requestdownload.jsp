                    ...
                    <div class="modal-body">
                        ...
                        <ol>
                            <li>Enter the <strong>certificate serial number</strong> 
                                (this was e-mailed to you when your certificate was created)</li> 
                            <li>Enter the <strong>e-mail address</strong> that you used 
                                to request the certificate</li> 
                        ...
                        <strong>browser certificate file</strong> for importing into a web browser (a file with a '.p12' extension
                        ...
                        <ol>
                            ...
                            <li><strong>Select your private key</strong>. Either paste your privateKey 
                                ...
                                requesting your certificate</li>
                            <li><strong>Provide your password</strong> - this will decrypt your privateKey</li>
                            <li><strong>Click 'Save Certificate'</strong> and save your browser certificate file in a safe place</li>
        ...
        <div id="wrap">
            <div class="row">
                <div class="col-xs-offset-1">
                        ...
                        <c:if test="${not empty successMessage}">
                            <div class="success">
                                <ul>
                                    ...
                                    <li><strong>Follow Steps 1,2,3 below </strong>to create a browser compatible certificate file 
                                </ul>
                            </div>
                        </c:if>
                    ...
                    <c:if test="${cert == null}">
                        <br/>
                        <form:form id="requestCertForm" method="post" action="${pageContext.request.contextPath}/pub/downloadCert/requestdownload"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
                                    <form:input id="certId" class="form-control" path="certId" placeholder="12345" /> <span></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
                                    <form:input id="email" class="form-control" path="email" placeholder="some.body@world.com" /> <span></span>
...
<!--                                                    <strong>Provide Your Private Key</strong> -->
                                                    <ul>
                                                        ...
                                                        <li>This file was saved when applying for the certificate using this portal</li>
