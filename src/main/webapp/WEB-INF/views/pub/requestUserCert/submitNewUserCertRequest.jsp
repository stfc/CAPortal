                    ...
                    <div class="modal-body">
                       ...
                       <ol>
                           ...
                           <li><strong>Save the highlighted text</strong> to a local text file, either: <br/>
                            ...
                            <li><strong>An acknowledgement email</strong> is sent to you with details of your local/nearest institution's 
                                <abbr title="A person who will view your photo-ID and will approve your request">RA operator</abbr></li>
        ...
        <div id ="wrap">
            <div class="row">
                <div class="col-xs-offset-1">
                    ...
                    -->
                    <a id="postLinkCsr" href="${pageContext.request.contextPath}/pub/requestUserCert/postCsr" style="display: none;"></a>
                    <a id="postLinkCsrAttributes" href="${pageContext.request.contextPath}/pub/requestUserCert/postCsrAttributes" style="display: none;"></a>
                    
                    <form action="" class="form-horizontal" role="form">
                        <div class="form-group">
                            <div class="col-xs-3 col-lg-3">
                                <strong><a href="#" id="cnInputTextTitle" tabindex="-1" data-toggle="tooltip" data-placement="right" 
                                title="Full name will make up the Common Name of your certificate">Name</a></strong> <font class="muted">(firstname lastname)</font>
                            </div>
                            <div class="col-xs-8 col-sm-6 col-md-5 col-lg-3">
                                <input type="text" id="cnInputText" class="form-control" onChange="javascript:this.value=this.value.toLowerCase();"/>
                                <span></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3 col-lg-3">
                                ...
                                title="After applying for your certificate, you will need to visit your local/nearst institution RA and provide photo-ID">Your Institution</a></strong>
                        ...
                        <div class="form-group">
                            <div class="col-xs-3 col-lg-3">
                                <strong><a href="#" id="emailInputTextTitle" tabindex="-1" data-toggle="tooltip" data-placement="right" 
